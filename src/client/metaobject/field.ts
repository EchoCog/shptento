...
export abstract class Field<T, TRequired extends boolean = boolean> {
    ...
    constructor(config: MetaobjectFieldDefinitionConfigWithType<any, TRequired extends true ? true : false>, validations: Validations) {
        this._ = {
...
export class SingleLineTextField<TRequired extends boolean = false> extends Field<string, TRequired> {
    constructor(config: MetaobjectFieldDefinitionConfig<SingleLineTextFieldValidations, TRequired extends true ? true : false>, validations: Validations) {
        super({ ...config, type: 'single_line_text_field' }, validations);
    }
}

export function singleLineTextField<TRequired extends boolean, T extends MetaobjectFieldDefinitionConfig<SingleLineTextFieldValidations, TRequired extends true ? true : false>>(
    config?: T,
): SingleLineTextField<T['required'] extends true ? true : false> {
    return new SingleLineTextField<T['required'] extends true ? true : false>(config as any ?? {}, singleLineTextFieldValidations);
}
...
export class MultiLineTextField<TRequired extends boolean = false> extends Field<string, TRequired> {
    constructor(config: MetaobjectFieldDefinitionConfig<MultiLineTextFieldValidations, TRequired extends true ? true : false>, validations: Validations) {
        super({ ...config, type: 'multi_line_text_field' }, validations);
    }
}

export function multiLineTextField<TRequired extends boolean, T extends MetaobjectFieldDefinitionConfig<MultiLineTextFieldValidations, TRequired extends true ? true : false>>(
    config?: T,
): MultiLineTextField<T['required'] extends true ? true : false> {
    return new MultiLineTextField<T['required'] extends true ? true : false>(config as any ?? {}, multiLineTextFieldValidations);
}
...
export class DecimalField<TRequired extends boolean = false> extends Field<number, TRequired> {
    constructor(config: MetaobjectFieldDefinitionConfig<DecimalFieldValidations, TRequired extends true ? true : false>, validations: Validations) {
...
export function decimal<TRequired extends boolean, T extends MetaobjectFieldDefinitionConfig<DecimalFieldValidations, TRequired extends true ? true : false>>(
    config?: T
): DecimalField<T['required'] extends true ? true : false> {
...
export class DecimalListField<TRequired extends boolean = false> extends Field<number[], TRequired> {
    constructor(config: MetaobjectFieldDefinitionConfig<DecimalListFieldValidations, TRequired extends true ? true : false>, validations: Validations) {
...
export function decimalList<TRequired extends boolean, T extends MetaobjectFieldDefinitionConfig<DecimalListFieldValidations, TRequired extends true ? true : false>>(
    config?: T,
): DecimalListField<T['required'] extends true ? true : false> {
    return new DecimalListField<T['required'] extends true ? true : false>(config as any ?? {}, decimalListFieldValidations);
}
...
export class UrlField<TRequired extends boolean = false> extends Field<string, TRequired> {
    constructor(config: MetaobjectFieldDefinitionConfig<UrlValidations, TRequired extends true ? true : false>, validations: Validations) {
        super({ ...config, type: 'url' }, validations);
    }
}

export function url<TRequired extends boolean, T extends MetaobjectFieldDefinitionConfig<UrlValidations, TRequired extends true ? true : false>>(
    config?: T
): UrlField<T['required'] extends true ? true : false> {
...
export class IntegerField<TRequired extends boolean = false> extends Field<number, TRequired> {
    constructor(config: MetaobjectFieldDefinitionConfig<IntegerValidations, TRequired extends true ? true : false>, validations: Validations) {
...
export function integer<TRequired extends boolean, T extends MetaobjectFieldDefinitionConfig<IntegerValidations, TRequired extends true ? true : false>>(
    config?: T
): IntegerField<T['required'] extends true ? true : false> {
...
export class DateField<TRequired extends boolean = false> extends Field<Date, TRequired> {
    constructor(config: MetaobjectFieldDefinitionConfig<DateValidations, TRequired extends true ? true : false>, validations: Validations) {
...
export function date<TRequired extends boolean, T extends MetaobjectFieldDefinitionConfig<DateValidations, TRequired extends true ? true : false>>(
    config?: T
): DateField<T['required'] extends true ? true : false> {
...
export class DateListField<TRequired extends boolean = false> extends Field<Date[], TRequired> {
    constructor(config: MetaobjectFieldDefinitionConfig<DateListValidations, TRequired extends true ? true : false>, validations: Validations) {
...
export function dateList<TRequired extends boolean, T extends MetaobjectFieldDefinitionConfig<DateListValidations, TRequired extends true ? true : false>>(
    config?: T
): DateListField<T['required'] extends true ? true : false> {
...
export class DateTimeField<TRequired extends boolean = false> extends Field<Date, TRequired> {
    constructor(config: MetaobjectFieldDefinitionConfig<DateTimeValidations, TRequired extends true ? true : false>, validations: Validations) {
...
export function dateTime<TRequired extends boolean, T extends MetaobjectFieldDefinitionConfig<DateTimeValidations, TRequired extends true ? true : false>>(
    config?: T
): DateTimeField<T['required'] extends true ? true : false> {
...
export class DimensionField<TRequired extends boolean = false> extends Field<DimensionFieldValue, TRequired> {
    constructor(config: MetaobjectFieldDefinitionConfig<DimensionValidations, TRequired extends true ? true : false>, validations: Validations) {
...
export function dimension<TRequired extends boolean, T extends MetaobjectFieldDefinitionConfig<DimensionValidations, TRequired extends true ? true : false>>(
    config?: T
): DimensionField<T['required'] extends true ? true : false> {
...
export class DimensionListField<TRequired extends boolean = false> extends Field<DimensionFieldValue[], TRequired> {
    constructor(config: MetaobjectFieldDefinitionConfig<DimensionListValidations, TRequired extends true ? true : false>, validations: Validations) {
...
export function dimensionList<TRequired extends boolean, T extends MetaobjectFieldDefinitionConfig<DimensionListValidations, TRequired extends true ? true : false>>(
    config?: T,
): DimensionListField<T['required'] extends true ? true : false> {
    return new DimensionListField<T['required'] extends true ? true : false>(config as any ?? {}, dimensionListValidations);
}
...
export class VolumeField<TRequired extends boolean = false> extends Field<VolumeFieldValue, TRequired> {
    constructor(config: MetaobjectFieldDefinitionConfig<VolumeValidations, TRequired extends true ? true : false>, validations: Validations) {
...
export function volume<TRequired extends boolean, T extends MetaobjectFieldDefinitionConfig<VolumeValidations, TRequired extends true ? true : false>>(
    config?: T
): VolumeField<T['required'] extends true ? true : false> {
...
export class VolumeListField<TRequired extends boolean = false> extends Field<VolumeFieldValue[], TRequired> {
    constructor(config: MetaobjectFieldDefinitionConfig<VolumeListValidations, TRequired extends true ? true : false>, validations: Validations) {
...
export function volumeList<TRequired extends boolean, T extends MetaobjectFieldDefinitionConfig<VolumeListValidations, TRequired extends true ? true : false>>(
    config?: T,
): VolumeListField<T['required'] extends true ? true : false> {
...
export class WeightField<TRequired extends boolean = false> extends Field<WeightFieldValue, TRequired> {
    constructor(config: MetaobjectFieldDefinitionConfig<WeightValidations, TRequired extends true ? true : false>, validations: Validations) {
...
export function weight<TRequired extends boolean, T extends MetaobjectFieldDefinitionConfig<WeightValidations, TRequired extends true ? true : false>>(
    config?: T
): WeightField<T['required'] extends true ? true : false> {
...
export class WeightListField<TRequired extends boolean = false> extends Field<WeightFieldValue[], TRequired> {
    constructor(config: MetaobjectFieldDefinitionConfig<WeightListValidations, TRequired extends true ? true : false>, validations: Validations) {
...
export function weightList<TRequired extends boolean, T extends MetaobjectFieldDefinitionConfig<WeightListValidations, TRequired extends true ? true : false>>(
    config?: T,
): WeightListField<T['required'] extends true ? true : false> {
